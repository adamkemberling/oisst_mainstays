...
**3. Detrend anomalies** - Why not just temperature? **(answer: confusing to match them to thresholds but same results)**

4.  Calculate thresholds

**5. Identify MHWs** - Won't these change retroactively? **(answer: yes)**

## Comparing the Four Options:

Changing the Baseline & De-Trending
