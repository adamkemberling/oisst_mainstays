...
world_ts <- read_csv(paste0(oisst_path, "global_timeseries/global_anoms_1982to2011.csv"), 
    guess_max = 1e6,
    col_types = cols()) %>% 
  mutate(year = year(time))
nelme_ts <- oisst_access_timeseries("lme", "northeast us continental shelf")
gom_ts   <- oisst_access_timeseries(region_family = "gmri focus areas", "apershing gulf of maine")
ss_ts    <- oisst_access_timeseries(region_family = "lme", "scotian shelf")
bf_ts    <- oisst_access_timeseries(region_family = "gom physio regions", "bay of fundy")
lis_ts   <- oisst_access_timeseries("gmri focus areas", "long island sound")
