...
During 2021 there were `r events_num` main marine heatwave events, including one that carried over from the previous year and one that has continued into 2022. The average duration for these events was `r avg_duration` days (excluding days in 2020 & 2022).
