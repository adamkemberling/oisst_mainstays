...
# Plot them
ersst_long_term_p <- ggplot(data = ersst_yr) +
...
eq_all    <- paste0("GoM 1982-2021: ", decade_all,    "\u00b0", "C / Decade")
eq_15     <- paste0("GoM 2007-2021: ", decade_15,     "\u00b0", "C / Decade")
eq_global <- paste0("World 1982-2021: ", decade_global, "\u00b0", "C / Decade")
...
# Single Line Plot
(temp_simplified <- ggplot(data = annual_summary, aes(year, area_wtd_anom)) +
...
ggsave(plot = hottest_yr_panels, filename = str_c(save_location, "gom_hottest_year_panels.png"),
       dpi = "retina", bg = "white")

# Weekly Report Table
gtsave(data = lme_rank_table, filename = str_c(save_location, "lme_warming_table.png"))
