...
```{r}
plot_masked_season("Winter", year_lab = "2020-2021", temp_lim = 5)
```

##### Spring

```{r}
plot_masked_season("Spring", year_lab = "2021", temp_lim = 5)
```
...
```{r}
plot_masked_season("Summer", year_lab = "2021", temp_lim = 5)
```
...
```{r}
plot_masked_season("Fall", year_lab = "2021", temp_lim = 5)
```
