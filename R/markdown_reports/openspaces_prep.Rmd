...
# # Crop to local area:
ranks_gom <- mask_nc(ras_obj = annual_rates, mask_shape = crop_extent, rotate = T)
...
This stackoverflow question asks details aroundhow those can be saved from R:
...
tiff_list <- list(
  "sst1990" = temp_hires$X1990s,
  "sst2000" = temp_hires$X2000s,
  "sst2010" = temp_hires$X2010s,
