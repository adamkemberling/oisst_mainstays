...
# rate_data <- list(
#   "GoM All F" = get_decadal_rates(temp_df = seasonal_avgs, 
#                                   temp_col = "area_wtd_f", 
#                                   year_col = "year", 
...
hw_temp_p <- ggplot(last_yr_heatwaves, aes(x = time)) +
    ...
    labs(x = "", 
         ...
         subtitle = str_c(params$season, params$year, ": Heatwave Conditions", sep = " ")) #+
