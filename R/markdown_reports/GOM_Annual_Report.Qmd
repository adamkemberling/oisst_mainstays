...
natl_23 %>% 
  ...
  geom_line(
   ...
   geom_text(
    data = natl_22 %>% slice(yday(min(natl_ts$time))+37),
...
# Make a similar plotfor the  Gulf of Maine
gom_23 %>% 
  ggplot(aes(flat_date, anom_f)) +
  geom_ribbon(
