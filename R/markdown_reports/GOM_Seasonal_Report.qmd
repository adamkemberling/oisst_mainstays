...
# Combine them
heatmap_p <- (fixed_hw | detrend_hw) + plot_layout(guides = "collect") & theme(legend.position = "bottom") 
heatmap_p 
...
From an aerial perspective, the Gulf of Maine experienced below-average SSTs during `r params$seas` of `r params$year`. 
