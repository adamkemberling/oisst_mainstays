...
pretty_numbers <- list("1" = "new","2" = "2nd","3" = "3rd","4" = "4th","5" = "5th", "6" = "6th","7" = "7th","8" = "8th","9" = "9th","10" = "10th", "11" = "11th", "12" = "12th", "13" = "13th", "14" = "14th", "15" = "15th", "16" = "16th", "17" = "17th", "18" = "18th", "19" = "19th", "20" = "20th", "21" = "21st", "22" = "22nd", "23" = "23rd", "24" = "24th", "25" = "25th", "26" = "26th")
...
`r params$seas` average SST were on average `r round(mean(this_season_data$anom_f),2)`°F below normal, with weekly SST anomalies ranging from -1.68°F to +0.41°F; all but one week at the end of 2023 recorded SSTs that were below the 1991-2020 average.
...
#| fig.height: 6
#| fig-cap: "A ranking of the 25 warmest winter seasons for the Gulf of Maine in the satellite record (1982-2023). 2023-24 was the twenty-third warmest winter on record."
...
# Pulling out yearly summary of MHWs for tv graphic


# events_summ <- hw_dat %>% #glimpse()
#   filter(yr < 2025) %>% #glimpse()
#   mutate(
#     mhw_event_no = if_else(mhw_event_no == "NA", NA, mhw_event_no),
#     mcs_event_no = if_else(mcs_event_no == "NA", NA, mcs_event_no)) %>% 
#   group_by(yr) %>% 
#   summarise(
#     hw_count = n_distinct(mhw_event_no, na.rm = T),
#     hw_day_total = sum(mhw_event, na.rm = T)#,
#     # cs_count = n_distinct(mcs_event_no, na.rm = T),
#     # cs_day_total = sum(mcs_event, na.rm = T)
#   )
# 
# write_csv(events_summ, here::here("local_data/gom_mhw_summary_WMTW.csv"))
# 
# 
# ggplot(events_summ, aes(yr, hw_count)) +
#   geom_point(aes(size = hw_day_total)) +
#   scale_x_continuous(breaks = seq(1980, 2025,5)) +
#   scale_y_continuous(breaks = c(0:10)) +
#   theme(legend.position = "inside",
#         legend.position.inside = c(0.3, 0.7)) +
#   labs(x = "Year", y = "Number of MHW's", size = "Days of MHW Conditions")
...
fixed_hw <- hw_dat %>% 
   mutate(
    ...
    geom_tile(
      aes(fill = {{ anom_col }},#), 
      #alpha = I(hwcs_event_alpha)),
      #alpha = I(season_alpha)),
      ), alpha = 0.8,
      color = "transparent") +
...
(static_baseline_concept / fixed_hw) + plot_layout(heights = c(2,5))
```
...
(detrend_concept / detrend_hw) + plot_layout(heights = c(2,5))
```
...
#| fig.height: 4
#| fig.align: center
#| fig-cap: "This series of maps shows the average monthly SST anomaly for December 2023, January 2024, and February 2024. The box outlined by the black dashed line denotes the region of study for the analysis. Darker red regions indicate warmer anomalies."
...
> Gulf of Maine Research Institute. 2024. Gulf of Maine Warming Update: `r params$season` 2024 
