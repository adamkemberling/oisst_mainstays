...
hw_plot_lims <- ifelse(
  ...
  as.Date(c(str_c(params$year-1, "-12-01"), str_c(params$year, "-04-30"))),
  as.Date(str_c(params$year, c("-01-01", "-12-31"))))
