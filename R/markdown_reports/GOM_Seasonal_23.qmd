...
The highest daily SST anomalies for `r params$seas` 2023-2024 occurred towards the end of December, with anomalies near `r max_int`°F above the climatological average. All daily SSTs after January 1st were below the climatological average, contributing to this season's unexpectedly low ranking.
...
monthly_maps <- (
  month_plots[[1]] + labs(title = "December 2023") | # WINTER control
  # month_plots[[1]] |
    month_plots[[2]] | 
    month_plots[[3]]) + 
...
Read on for an inside look at what we've learned in our `r params$seas` 2023 Gulf of Maine warming update.
