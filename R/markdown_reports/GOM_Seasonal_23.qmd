...
temp_rankings_p <- seasonal_ranks %>% 
  ...
  coord_cartesian(clip = "off") +
  geom_logo(x_npc = 0.85, y_npc = 1.075, logo_height = 1, height_units = "cm")
...
hw_temp_p <- year_hw_temps_two(
  ...
  labs(title = str_c("Gulf of Maine SST")) +
...
season_map <- ggplot() +
  ...
  guides("fill" = guide_colorbar(
    ...
    frame.colour = "black",
    ticks.colour = "black")) +
  labs(title = str_c("Seasonal Sea Surface Temperature Anomaly\n", params$season, " ", params$year),
