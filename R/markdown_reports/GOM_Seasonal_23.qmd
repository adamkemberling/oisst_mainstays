...
```{r}
#| eval: false
#| label: playing with seasonal alpha


# hw_dat <- grid_dat %>% 
#   mutate(season_alpha = if_else(
#     between(flat_date, as.Date("2000-05-30"), as.Date("2000-09-01")),
#     1,
#     0.8)) 
# 
# 
# 
# 
# ggplot(hw_dat, aes(x = flat_date, y = year)) +
...
#     # tile for sst colors
#     geom_tile(aes(fill = {{ anom_col }}, alpha = I(season_alpha)), 
#               color = "transparent") +
