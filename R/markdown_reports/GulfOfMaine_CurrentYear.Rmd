---
title: "Gulf of Maine SST Report"
author: 
  - first_name: "Adam"
...
```{r params formatting, echo = FALSE}
...
ggplot(data = one_yr, aes(x = flat_date)) +
    ...
    geom_textline(aes(y = mhw_thresh, color = "90th Percentile", label = "Heatwave Threshold"), linetype = 2, size = 4, hjust = 0.4) +
    geom_textline(aes(y = mcs_thresh, color = "10th Percentile", label = "Coldspell Threshold"), linetype = 2, size = 4, hjust = 0.6) +
...
ggplot(monthly_temps, aes(x = time, y = 0)) +
  ...
  labs(title = str_c(tidy_name, " - Monthly Sea Surface Temperature Anomalies"),
       x = "",
...
ggplot(data = one_yr, aes(x = flat_date)) +
    ...
    geom_textline(aes(y = seas, label = "Climatological Average"),
                  linetype = 1, size = 4, hjust = 0.5) +
    geom_line(aes(y = mhw_thresh, color = "90th Percentile"), linetype = 3, size = 0.5) +
    geom_line(aes(y = mcs_thresh, color = "10th Percentile"), linetype = 3, size = 0.5) +
    geom_line(data = this_yr_hw,  
              aes(flat_date, sst), size = 1, color = gmri_cols("orange")) +
    scale_x_date(date_labels = "%b", date_breaks = "1 month", expand = expansion(add = c(0,0))) +
    scale_y_continuous(labels = number_format(suffix = " \u00b0C")) +
    scale_color_manual(values = clim_colors) +
    labs(x = "Day of the Year", y = "Sea Surface Temperature",
...
# 4: Mapping Regional Temperatures
