...
ggplot(data = one_yr, aes(x = flat_date)) +
    ...
    geom_textline(aes(y = mhw_thresh, color = "90th Percentile", label = "Heatwave Threshold"), linetype = 2, size = 4, hjust = 0.4, linewidth = 1) +
    geom_textline(aes(y = mcs_thresh, color = "10th Percentile", label = "Coldspell Threshold"), linetype = 2, size = 4, hjust = 0.6, linewidth = 1) +
...
::: {.panelset}
::: {.panel}
### Last Full Year (Interactive) {.panel-name}
