...
# Load the bounding box for Northeast Shel
...
During September, extratropical storm Lee traversed the Northeast Shelf, which weakened from hurricane strength as it crossed over Georges Bank on September 16. The impacts of this storm on the region’s SSTs can be seen in @fig-gom-record-temps when temperature fell over 5F over a period of 12 days.
...
rank_plot_data <- annual_summary %>% 
  ...
  mutate(
    ...
    flag_col = ifelse(year == 2023, gmri_cols("lv orange"), gmri_cols("gmri blue")),
